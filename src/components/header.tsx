    ...
    return (
        <HeaderWrapper id="top">
            <Content className="flex-row between centered-align">
                ...
                <Menu>
                    <MenuLink onClick={() => ScrollToSmooth('#projects')}>
                        {lang.projects}
                    </MenuLink>
                    <MenuLink onClick={() => ScrollToSmooth('#contacts')}>
                        {lang.contacts}
                    </MenuLink>
                    <MenuLink onClick={() => ScrollToSmooth('#certificates')}>
                        {lang.certificates}
                    </MenuLink>
                    <MenuLink onClick={() => ScrollToSmooth('#stack')}>
                        {lang.stack}
                    </MenuLink>
                </Menu>
